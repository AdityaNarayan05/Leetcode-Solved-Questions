...
public:
    int shortestPathAllKeys(vector<string>& grid) {
        ...
        vector<vector<vector<bool>>> vis(m,vector<vector<bool>>(n,vector<bool>(64,0))); //at most 6 keys, using bitmap 111111
        ...
        while(!q.empty()){
            ...
            for(int i=0;i<sz;i++){
                ...
                if(carry==((1<<K)-1))
                    return path; //if all keys hold, just return 
